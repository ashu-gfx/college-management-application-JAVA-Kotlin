...
public class ImageUploadPreview1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image_upload_preview1);
        ...
        imgPath.putFile(imageUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
            ...
            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(ImageUploadPreview1.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
...
//                    sendPushNotification.startPush(user.getDisplayName(), finalMessage,"global_chat");
                    Toast.makeText(ImageUploadPreview1.this, "Message Send", Toast.LENGTH_SHORT).show();
                    chat_box.setText("");
                    dialog.dismiss();
                    finish();
                } else {
...
//    public void addMessageToTheDatabase(Uri uri, String messageID) {
//
//        FirebaseUser user = mAuth.getCurrentUser();
//        String message = chat_box.getText().toString();
//        if (TextUtils.isEmpty(message)) {

...
public class at_me_sempage extends AppCompatActivity {

    ImageView profileImage06;
    FirebaseAuth fAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_at_me_sempage);
        profileImage06 = findViewById(R.id.profileImage06);
        ...
        profileRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                Picasso.get().load(uri).into(profileImage06);
            }
        });

        profileImage06.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent img = new Intent(at_me_sempage.this, MainActivity.class);
                startActivity(img);

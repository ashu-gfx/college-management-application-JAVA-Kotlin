...
public class n_ce_sempage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nce_sempage);

        profileImage19 = findViewById(R.id.profileImage19);
        ...
        profileRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                Picasso.get().load(uri).into(profileImage19);
            }
        });

        profileImage19.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent img = new Intent(n_ce_sempage.this, MainActivity.class);
                startActivity(img);

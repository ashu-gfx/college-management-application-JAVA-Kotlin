...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Swipeimage = findViewById(R.id.swipeimage);
...
//imageViewtest = findViewById(R.id.testimage);
        ...
        // optcardview = findViewById(R.id.optcardview);
        //  swipeListener = new SwipeListener(relativeLayout);
        // swipeListener1 = new SwipeListener(imageViewtest);
        //swipeListener1 = new SwipeListener(optcardview);
        //
        //   FirebaseAuth.getInstance().signOut();

        navigationView = findViewById(R.id.nav);
        navigationView.setSelectedItemId(R.id.Global_Chat);
...
//
//                Intent img = new Intent(StartPage.this, MainActivity.class);
//                startActivity(img);
//
//            }
//        });
...
//                        break;
        ...
        Glide.with(this).load(R.drawable.chat).into((ImageView) findViewById(R.id.imageView2));
    }
                                ...
                                if (Math.abs(xDiff) > Math.abs(yDiff)) {
                                    if (Math.abs(xDiff) > threshold
                                        ...
                                        if (xDiff > 0) {
                                            ...
                                            // Right Swipe
                                            startActivity(new Intent(StartPage.this, menupage2.class));
                                            overridePendingTransition(0, 0);
                                            Toast.makeText(StartPage.this, "Swiped Right", Toast.LENGTH_SHORT).show();
                                            ...
                                            startActivity(new Intent(StartPage.this, Startpage_notifications.class));
                                            overridePendingTransition(0, 0);
                                            Toast.makeText(StartPage.this, "Swiped Left", Toast.LENGTH_SHORT).show();

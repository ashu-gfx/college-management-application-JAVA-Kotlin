...
public class at_e_sempage extends AppCompatActivity {

    ImageView profileImage05;
    FirebaseAuth fAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_at_esempage);

        profileImage05 = findViewById(R.id.profileImage05);
        ...
        profileRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                Picasso.get().load(uri).into(profileImage05);
            }
        });

        profileImage05.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent img = new Intent(at_e_sempage.this, MainActivity.class);
                startActivity(img);

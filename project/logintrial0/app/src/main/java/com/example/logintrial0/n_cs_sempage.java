...
public class n_cs_sempage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ncs_sempage);

        profileImage18 = findViewById(R.id.profileImage18);
        ...
        profileRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                Picasso.get().load(uri).into(profileImage18);
            }
        });

        profileImage18.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent img = new Intent(n_cs_sempage.this, MainActivity.class);
                startActivity(img);

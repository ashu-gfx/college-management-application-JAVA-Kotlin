...
public class at_ec_sempage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_at_ec_sempage);
        ...
        profileImage04.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent img = new Intent(at_ec_sempage.this, MainActivity.class);
                startActivity(img);

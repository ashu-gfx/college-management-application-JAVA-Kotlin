...
public class Register extends AppCompatActivity {
    ...
    EditText mFullName, mEmail, mPassword, mPhone, mEnrollmentNo , mLastname;
    Button mRegisterBtn;
    TextView mLoginBtn;
    FirebaseAuth fAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLoginBtn = findViewById(R.id.login_);
        mEnrollmentNo = findViewById(R.id.enrollment_no1);
        ...
        mRegisterBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String EnrollmentNo = mEnrollmentNo.getText().toString();
                ...
                fAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            user.put("enrollment",EnrollmentNo);

...
public class t_ec_sempage extends AppCompatActivity {
    ImageView profileImage09;
    FirebaseAuth fAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tec_sempage);

        profileImage09 = findViewById(R.id.profileImage09);
        ...
        profileRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                Picasso.get().load(uri).into(profileImage09);
            }
        });

        profileImage09.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent img = new Intent(t_ec_sempage.this, MainActivity.class);
                startActivity(img);

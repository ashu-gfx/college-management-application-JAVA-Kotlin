...
public class n_me_sempage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nme_sempage);

        profileImage15 = findViewById(R.id.profileImage15);
        ...
        profileRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                Picasso.get().load(uri).into(profileImage15);
            }
        });

        profileImage15.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent img = new Intent(n_me_sempage.this, MainActivity.class);
                startActivity(img);

...
public class attendance_main extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileImage01 = findViewById(R.id.profileImage01);
        ...
        profileRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                Picasso.get().load(uri).into(profileImage01);
            }
        });

        profileImage01.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent img = new Intent(attendance_main.this, MainActivity.class);
                startActivity(img);
        ...
        androidImageButton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(attendance_main.this, "it works", Toast.LENGTH_LONG).show();
                at_cs();
    ...
    public void  at_cs() {
        Intent intent1 = new Intent(this,at_cs_sempage .class);
    ...
    public void at_ec() {
        Intent intent2 = new Intent(this,at_ec_sempage.class);
        startActivity(intent2);


    }
    public void at_ce() {
        Intent intent3 = new Intent(this,at_ce_sempage.class);
    ...
    public void  at_me() {
        Intent intent4 = new Intent(this, at_me_sempage.class);
    ...
    public void at_e() {
        Intent intent5 = new Intent(this, at_e_sempage.class);
